...
byte des_key[] = {0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef};
...
void loop() {
  ...
  back_k();
  //-------------------------------------------------------------------------------
  Serial.println("Open a file called 'encr.txt' and read the data from it");
  testfile = SD.open("encr.txt", FILE_READ); // FILE_WRITE opens file for writing and moves to the end of the file
