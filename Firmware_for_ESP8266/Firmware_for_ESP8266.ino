    ...
    if (digitalRead(5) == LOW){
     ...
     if (digitalRead(5) == LOW){
      ...
      for(int i = 0; i < 80; i++)
        tft.print(" ");
      tft.setCursor(0,304);
      tft.printf("File to be opened:%d", nmb);
      }
    }
    delay(90);
  }
...
void read_book(String fname){
  File chosenBook;
  back_k();
  bool cls_b = false;
  chosenBook = SD.open(fname, FILE_READ);
  int n = 0;
