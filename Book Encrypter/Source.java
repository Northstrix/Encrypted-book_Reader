    ...
    private static final byte[] rotations = {
      ...
      public static void encr_book() {
          ...
          if (returnValue == JFileChooser.APPROVE_OPTION) {
              ...
              try {
				encrypt_book(jfc.getSelectedFile().toString(), jfc.getSelectedFile().toString() + ".encr");
			} catch (Exception e) {
      ...
      public static void encrypt_book(String src, String dst) throws Exception {
      	key_back = ck;
      	key_back2 = ck2;
      	key_back3 = ck3;
          String st;
      ...
      public static void select_key() {
          ...
          if (returnValue == JFileChooser.APPROVE_OPTION) {
              ...
              try {
                  ...
                  */
                  inf.setText("Select the book to encrypt.");
                } catch (IOException r) {
                    System.out.println("An error occurred.");
                    r.printStackTrace();
                  }
  	...
  	public static void about_be(){
		JFrame about_pr = new JFrame("About Book Encrypter");
		
		about_pr.setBounds(300, 90, 390, 194);
		about_pr.setResizable(false);
		JPanel c1 = new JPanel(new SpringLayout());
		
		JLabel q1 = new JLabel("Book encrypter is a software that encrypts books", SwingConstants.CENTER);
		q1.setFont(new Font("Arial", Font.PLAIN, 14));
		c1.add(q1);
		
		JLabel q2 = new JLabel("for the Encrypted-book Reader.", SwingConstants.CENTER);
		q2.setFont(new Font("Arial", Font.PLAIN, 14));
		c1.add(q2);
		
		JLabel q3 = new JLabel("For more information please visit:", SwingConstants.CENTER);
		q3.setFont(new Font("Arial", Font.PLAIN, 14));
		c1.add(q3);
		
		TextField tl1 = new TextField("https://github.com/Northstrix/Encrypted-book_Reader",SwingConstants.CENTER);
		tl1.setFont(new Font("Arial", Font.PLAIN, 14));
		c1.add(tl1);
		
		TextField tl2 = new TextField("https://www.instructables.com/Encrypted-book-Reader/", SwingConstants.CENTER);
		tl2.setFont(new Font("Arial", Font.PLAIN, 14));
		c1.add(tl2);
		
		JButton cl1 = new JButton("OK");

        Color blue_cl = new Color(65, 165, 245);
        Color white_cl = new Color(239, 239, 239);
        
		c1.setBackground(blue_cl);
		q1.setForeground(white_cl);
		q2.setForeground(white_cl);
		q3.setForeground(white_cl);
		tl1.setForeground(white_cl);
		tl2.setForeground(white_cl);
	    tl1.setBackground(blue_cl);
	    tl2.setBackground(blue_cl);
		cl1.setForeground(white_cl);
	    cl1.setBackground(blue_cl);
      ...
      public static void main(String[] args) {
          JMenu menu;
          JMenuItem eb, sk, qt;
          JFrame f= new JFrame("Book Encrypter");
          JMenuBar mb=new JMenuBar();
          JButton about_b = new JButton("About");
          menu=new JMenu(" File ");
          eb = new JMenuItem("Encrypt Book");
          ...
          Color blue_cl = new Color(65, 165, 245);
          Color white_cl = new Color(239, 239, 239);
          Color purple_cl = new Color(149, 32, 111);
          mb.setBackground(blue_cl);
          about_b.setBackground(blue_cl);
          menu.setForeground(white_cl);
          about_b.setForeground(white_cl);
          eb.setForeground(white_cl);
          sk.setForeground(white_cl);
          qt.setForeground(white_cl);
          eb.setBackground(blue_cl);
          sk.setBackground(blue_cl);
          qt.setBackground(blue_cl);
          inf = new JLabel();
          inf.setText("Select the encryption key.");
          JPanel p = new JPanel();
          p.add(inf);
          p.setBackground(purple_cl);
          inf.setForeground(white_cl);
          f.add(p);
          ...
          {
          		if (ck != null && !ck.isEmpty() && ck2 != null && !ck2.isEmpty() && ck3 != null && !ck3.isEmpty()) {
          			inf.setText("Encrypting book. It might take several minutes.");
          			encr_book();
          			inf.setText("Select the book to encrypt.");
          		}
          		else {
          			JFrame skform = new JFrame();
          			JOptionPane.showMessageDialog(skform, "Please select an encryption key to continue.\nFile -> Select encryption key", "Error", JOptionPane.WARNING_MESSAGE);
          		}
          });
